...
function show(dimensionAndMetricsData) {
  ...
  for (let topLocation of dimensionAndMetricsData.rows) {
      ...
      const progressBar = `<div class="progress">
                            <div class="progress-bar" role="progressbar" style="width: ${metricValue}%" aria-valuenow="${metricValue}" aria-valuemin="0" aria-valuemax="100">${metricValue}</div>
                          </div>`;
...
fetch('https://analyticsdashboard.dotzoo.net/api/Dzoapps/DzoappsTrafficSource.php')
