// api url
const dimensionAndMetrics = "https://analyticsdashboard.dotzoo.net/api/Exserosoft/Exserosoft_Run_Report.php";
const metrics = "https://analyticsdashboard.dotzoo.net/api/Exserosoft/Exserosoft_Metrics.php";
const deviceCategory = "https://analyticsdashboard.dotzoo.net/api/Exserosoft/Exserosoft_Device_Category.php";
const topPages = "https://analyticsdashboard.dotzoo.net/api/Exserosoft/Exserosoft_Top_Pages.php";
const trafficSource = "https://analyticsdashboard.dotzoo.net/api/Exserosoft/Exserosoft_Traffic_Source.php";
const searchConsole = "https://analyticsdashboard.dotzoo.net/api/Exserosoft/Exserosoft_Search_Console.php";
