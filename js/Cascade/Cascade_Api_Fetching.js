// api url
const dimensionAndMetrics = "https://analyticsdashboard.dotzoo.net/api/Cascade/Cascade_Run_Report.php";
const metrics = "https://analyticsdashboard.dotzoo.net/api/Cascade/Cascade_Metrics.php";
const deviceCategory = "https://analyticsdashboard.dotzoo.net/api/Cascade/Cascade_Device_Category.php";
const topPages = "https://analyticsdashboard.dotzoo.net/api/Cascade/Cascade_Top_Pages.php";
const trafficSource = "https://analyticsdashboard.dotzoo.net/api/Cascade/Cascade_Traffic_Source.php";
const searchConsole = "https://analyticsdashboard.dotzoo.net/api/Cascade/Cascade_Search_Console.php";
