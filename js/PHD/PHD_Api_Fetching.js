// api url
const dimensionAndMetrics = "https://analyticsdashboard.dotzoo.net/api/PHD/PHD_Run_Report.php";
const metrics = "https://analyticsdashboard.dotzoo.net/api/PHD/PHD_Metrics.php";
const deviceCategory = "https://analyticsdashboard.dotzoo.net/api/PHD/PHD_Device_Category.php";
const topPages = "https://analyticsdashboard.dotzoo.net/api/PHD/PHD_Top_Pages.php";
const trafficSource = "https://analyticsdashboard.dotzoo.net/api/PHD/PHD_Traffic_Source.php";
const searchConsole = "https://analyticsdashboard.dotzoo.net/api/PHD/PHD_Search_Console.php";
