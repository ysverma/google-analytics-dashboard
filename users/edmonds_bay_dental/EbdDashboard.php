...
<head>
    ...
    <!-- Custom JS link-->
	<script src="../../js/EBD/EBDapiFetching.js"></script>
	<script src="../../js/EBD/EBDshowData.js"></script>
...
<body>
	...
	<nav class="navbar-expand navbar-light bg-white topbar mb-4 static-top shadow ">
		    <div>
				...
				// 	$domain_name = $_SESSION["domainname"];
					...
					<div class="logout ">
						<h6 class="domain mt-3">Your Domain edmondsbaydental.com</h6>
    ...
    $(document).ready(function () {
      ...
      $.ajax({
        url: "../../api/Edmonds_Bay_Dental/EBDsearchConsole.php",
        type: "GET",
        dataType: "json",
