...
<head>
    ...
    <!-- Custom JS link-->
	<script src="../../js/Cascade/Cascade_Api_Fetching.js"></script>
	<script src="../../js/Cascade/Cascade_Show_Data.js"></script>
	...
	<title>Cascade Thermal-Dashboard</title>
</head>
...
<body>
	...
	<nav class="navbar-expand navbar-light bg-white topbar mb-4 static-top shadow ">
		    <div>
				...
				// 	$domain_name = $_SESSION["domainname"];
					...
					<div class="logout ">
						<h6 class="domain mt-3">Your Domain cascadethermal.com</h6>
		...
		<div class="col-xl-8 col-lg-7">
			<div class="card shadow mb-4">
				...
				<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
					<h6 class="m-0 font-weight-bold text-primary"> Traffic Source</h6>
    ...
    $(document).ready(function () {
      ...
      $.ajax({
        url: "../../api/Cascade/Cascade_Search_Console.php",
        type: "GET",
        dataType: "json",
