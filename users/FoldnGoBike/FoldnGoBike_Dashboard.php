...
<head>
    ...
    <!-- Custom JS link-->
	<script src="../../js/FoldnGoBike/FoldnGoBike_Api_Fetching.js"></script>
	<script src="../../js/FoldnGoBike/FoldnGoBike_Show_Data.js"></script>
	...
	<title>FoldnGoBikes-Dashboard</title>
</head>
...
<body>
	...
	<nav class="navbar-expand navbar-light bg-white topbar mb-4 static-top shadow ">
		    <div>
				...
				// 	$domain_name = $_SESSION["domainname"];
					...
					<div class="logout ">
						<h6 class="domain mt-3">Your Domain FoldnGoBikes.com</h6>
    ...
    $(document).ready(function () {
      ...
      $.ajax({
        url: "../../api/FoldnGoBike/FoldnGoBike_Search_Console.php",
        type: "GET",
        dataType: "json",
