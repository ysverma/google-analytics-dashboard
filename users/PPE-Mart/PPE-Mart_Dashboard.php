...
<head>
    ...
    <!-- Custom JS link-->
	<script src="../../js/PPE-Mart/PPE-Mart_Api_Fetching.js"></script>
	<script src="../../js/PPE-Mart/PPE-Mart_Show_Data.js"></script>
	...
	<title>PPE-Mart Dashboard</title>
</head>
...
<body>
	...
	<nav class="navbar-expand navbar-light bg-white topbar mb-4 static-top shadow ">
		    <div>
			    <div class="d-flex justify-content-between pb-4">
					...
					<div class="logout ">
						<h6 class="domain mt-3">Your Domain ppemart.com</h6>
    ...
    $(document).ready(function () {
      ...
      $.ajax({
        url: "../../api/PPE-Mart/PPE-Mart_Search_Console.php",
        type: "GET",
        dataType: "json",
