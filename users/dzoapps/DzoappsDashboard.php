...
<head>
    ...
    <!-- Custom JS link-->
	<script src="../../js/Dzoapps/DzoappsApiFetching.js"></script>
	<script src="../../js/Dzoapps/DzoappsShowData.js"></script>
...
<body>
		...
		<div>
			...
			<div>
				...
				// 	$domain_name = $_SESSION["domainname"];
					...
					<div class="logout ">
						<h6 class="domain mt-3">Your Domain dzoapps.com</h6>
    ...
    $(document).ready(function () {
      ...
      $.ajax({
        url: "../../api/Dzoapps/DzoappsSearchConsole.php",
        type: "GET",
        dataType: "json",
