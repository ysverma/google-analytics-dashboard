...
<head>
 ...
 <link rel="stylesheet" href="../../css/bootstrap/css/bootstrap.css"> 
    ...
    <!-- Custom JS link-->
	<script src="../../js/Dotzoo.com/Dotzoo-Api-Fetching.js"></script>
	<script src="../../js/Dotzoo.com/Dotzoo-show.js"></script>
	...
	<title>Dotzoo.com-Dashboard</title>
</head>
...
<body>
		...
		<div>
			...
			<div>
				...
				// 	$domain_name = $_SESSION["domainname"];
					...
					<div class="logout ">
						<h6 class="domain mt-3">Your Domain dotzoo.com</h6>
				...
				<div>
					<select id="date_range" name="date_range">
                        ...
                        <option value="28"<?php if(isset($_POST['date_range']) && $_POST['date_range'] == '28') echo ' selected'; ?>>Last 28 Days</option>
                         <option value="30"<?php if(isset($_POST['date_range']) && $_POST['date_range'] == '30') echo ' selected'; ?>>Last 30 Days</option>
    ...
    $(document).ready(function () {
      ...
      $.ajax({
        url: "../../api/Dotzoo/DotzooSearchConsole.php",
        type: "GET",
        dataType: "json",
