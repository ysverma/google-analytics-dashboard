...
<head>
    ...
    <!-- Custom JS link-->
	<script src="../../js/PHD/PHD_Api_Fetching.js"></script>
	<script src="../../js/PHD/PHD_Show_Data.js"></script>
...
<body>
	...
	<nav class="navbar-expand navbar-light bg-white topbar mb-4 static-top shadow ">
		    <div>
				...
				// 	$domain_name = $_SESSION["domainname"];
					...
					<div class="logout ">
						<h6 class="domain mt-3">Your Domain pacifichighwaydental.com</h6>
    ...
    $(document).ready(function () {
      ...
      $.ajax({
        url: "../../api/PHD/PHD_Search_Console.php",
        type: "GET",
        dataType: "json",
