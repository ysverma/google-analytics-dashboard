...
<head>
    ...
    <!-- Custom JS link-->
	<script src="../../js/IERM/IERM_Api_Fetching.js"></script>
	<script src="../../js/IERM/IERM_Show_Data.js"></script>
...
<body>
	...
	<nav class="navbar-expand navbar-light bg-white topbar mb-4 static-top shadow ">
		    <div>
				...
				// 	$domain_name = $_SESSION["domainname"];
					...
					<div class="logout ">
						<h6 class="domain mt-3">Your Domain &nbsp;   ie-rm.org</h6>
    ...
    $(document).ready(function () {
      ...
      $.ajax({
        url: "../../api/IERM/IERM_Search_Console.php",
        type: "GET",
        dataType: "json",
