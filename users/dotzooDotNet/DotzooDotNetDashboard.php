...
<head>
    ...
    <!-- Custom JS link-->
	<script src="../../js/Dotzoo.net/DotzooDotNet-Api-Fetching.js"></script>
	<script src="../../js/Dotzoo.net/DotzooDotNet-Show.js"></script>
	...
	<title>Dotzoo.net-Dashboard</title>
</head>
...
<body>
	...
	<nav class="navbar-expand navbar-light bg-white topbar mb-4 static-top shadow ">
		    <div>
				...
				// 	$domain_name = $_SESSION["domainname"];
					...
					<div class="logout ">
						<h6 class="domain mt-3">Your Domain dotzoo.net</h6>
    ...
    $(document).ready(function () {
      ...
      $.ajax({
        url: "../../api/DotzooDotNet/DotzooDotNetSearchConsole.php",
        type: "GET",
        dataType: "json",
