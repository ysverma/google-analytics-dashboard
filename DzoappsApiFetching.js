// api url
const dimensionAndMetrics = "http://localhost/Analytics_Dashboard/api/DzoappsRunReport.php";
const metrics = "http://localhost/Analytics_Dashboard/api/DzoappsMetrics.php";
const deviceCategory = "http://localhost/Analytics_Dashboard/api/DzoappsDeviceCategory.php";
const topPages = "http://localhost/Analytics_Dashboard/api/DzoappsTopPages.php";
const trafficSource = "http://localhost/Analytics_Dashboard/api/DzoappsTrafficSource.php";
const searchConsole = "http://localhost/Analytics_Dashboard/api/DzoappsSearchConsole.php";
