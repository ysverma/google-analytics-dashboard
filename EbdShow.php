...
<head>
	...
	<!-- Custom JS link-->
	<script src="js/EBDapiFetching.js"></script>
	<script src="js/EBDshowData.js"></script>
...
<body>
	...
	<script>
		...
		async function searchconsoleinit() {
			...
			// get the cats
			let searchconsoleresp = await fetch("./api/EBDsearchConsole.php");
		...
		async function topLocationinit() {
			...
			// get the cats
			let topLocationresp = await fetch("./api/EBDRunReport.php");
