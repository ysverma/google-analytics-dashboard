// api url
const dimensionAndMetrics = "http://localhost/edmonds_bay_dental_dashboard/api/EBDRunReport.php";
const metrics = "http://localhost/edmonds_bay_dental_dashboard/api/EBDmetrics.php";
const deviceCategory = "http://localhost/edmonds_bay_dental_dashboard/api/EBDdeviceCategory.php";
const topPages = "http://localhost/edmonds_bay_dental_dashboard/api/EBDtopPages.php";
const trafficSource = "http://localhost/edmonds_bay_dental_dashboard/api/EBDtrafficSource.php";
const searchConsole = "http://localhost/edmonds_bay_dental_dashboard/api/EBDsearchConsole.php";
